...
class SendMailController extends BaseUser
{
	...
	public function send($email = null, $subject = null)
	{
		...
		try {
			...
			$mail->Password   = 'bmnimnvsapvdeylv';                               //SMTP password
			...
			$mail->setFrom('tdkugletrakt@yandex.ru', 'Заявка с интернет-магазина ' . $_SERVER['HTTP_HOST']); // от кого и текст (заголовок письма)
			...
			$mail->addReplyTo('tdkugletrakt@yandex.ru'); // добавить ответ на
