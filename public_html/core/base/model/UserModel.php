...
class UserModel extends BaseModel
{
	...
	/** 
	 * свойство с именем куки для пользовательской части
	 */
	private $cookieName = 'identifier';

	/** 
	 * свойство с именем куки для административной части 
	 */
	...
	/** 
	 * свойство с таблицей БД (данные пользователей сайта)
	 */
	private $userTable = 'visitors';

	/** 
	 * свойство с таблицей БД (данные администрации сайта)
	 */
	private $adminTable = 'users';

	/** 
	 * свойство с таблицей БД (отвечает за некорректные попытки входа пользователей)
	 */
	...
	/** 
	 * Метод который будет выкидывать(удалять) куку пользователя
	 */
	public function logout()
	{
